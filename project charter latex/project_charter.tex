...
\newcommand{\teamname}{EngiMavs}
\newcommand{\productname}{Swift Scan}
...
\begin{figure}[h!]
	\centering
   	\includegraphics[width=0.60\textwidth]{images/example.jpg}
\end{figure}
\vspace{0.5 in}
...
\begin{versionhistory}
  	\vhEntry{0.1}{07.01.2019}{JW}{document creation}
\end{versionhistory}
\newpage
